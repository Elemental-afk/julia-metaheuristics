...
# ╔═╡ 91c353df-52fc-4833-ad2b-aa84c1973824
using PlutoUI

# ╔═╡ 129abf55-7b3f-4f49-8c51-157d6d41e901
using Plots

# ╔═╡ 3f531cb9-45d1-42aa-947f-c2e5cb1eb481
using BenchmarkTools

# ╔═╡ 84d17ce2-3ef1-483d-8678-beaac27fc4f2
using Random

# ╔═╡ f8cc9a73-3d04-4610-841c-3196e81dd116
using LinearAlgebra

# ╔═╡ 6831ceb7-4494-4280-b227-0d1d0b80f2c9
using DataFrames

# ╔═╡ 59d5678c-41a9-11f0-1cb7-175e566d537e
md"
## Metaheurystyki inaczej - język Julia

Pokażę 3 metody, które nietypowo zastosuję do sortowania zmiennych
- Simulated Annealing
- Genetic Algorithm
- Ant Colony Optimization

Oczywiście, jest to przede wszystkim pretekstem do zabawy z językiem Julia ;)
"

# ╔═╡ 7fe6983f-bd4c-45de-b806-db4d5a00c06f
md"
Poniżej - parę funkcji pomocniczych
"

# ╔═╡ 3aa40130-68d0-4ef2-8da9-bb67b3fb62f6
...
# ╔═╡ 932d89a5-05a9-400c-8cb1-4291b9561aa6
...
# ╔═╡ 266aaa10-73b0-4019-b5a5-fc60f47126d3
md"
Funkcja kosztu jest w zasadzie taka sama dla wszystkich 3 heurystyk
"

# ╔═╡ 8fb0d33e-85d8-4108-811c-733dc0e3af0e
...
# ╔═╡ d3062106-1abe-45ea-ae78-f32338764f9e
md"
## Symulowane wyżarzanie
"

# ╔═╡ 3ae85ba7-915f-4ef1-b040-8561b13ac9b0
...
# ╔═╡ 12e0c73d-aa7d-48cc-8e2a-1bb3b5716ece
...
# ╔═╡ efb77a6e-e069-477d-ba56-20cd811b42ef
begin
	array_a = random_array(100)
	println("Starting annealing with initial array:")
	println(array_a)
	result_array_a, final_cost_a = annealing(10000.0, array_a, "2rand", 0.999, 100000)
	println("Final array after annealing:")
	println(result_array_a)
	println("Final cost (number of inversions): ", final_cost_a)
end

# ╔═╡ 17417c49-c1a9-4c0d-9b33-4c50a3cb3e44
md"
## Algorytm genetyczny
"

# ╔═╡ 75ab763a-464d-48b5-b565-ee3e57e8f6eb
begin
...
# ╔═╡ 0441b78c-1c3b-4dc1-9793-f27c15cbc9cc
...
# ╔═╡ 3e4a404e-1ed8-42ab-8b3a-257256e65ed7
...
# ╔═╡ e98f8f5a-9a40-4086-9e5f-59b53b44c0d0
begin
	arr = shuffle(1:40)
	sorted_arr = ant_colony_sort(arr, 30, 6, 0.01, 10, 50)
	println("Sorted? ", is_sorted(sorted_arr))
end

# ╔═╡ d86e05fb-aa84-4f2d-ac1d-f78aeb676330
@bind arr_size Slider(5:1:100, show_value=true)

# ╔═╡ e115be7b-fc01-4f72-8ce5-3eb65bba6aa9
visarray = random_array(arr_size)

# ╔═╡ 4dcfbcc6-f758-4ba6-878a-b02381e6b5de
@bind vismethod Select(["Simulated Annealing", "Genetic Algorithm", "Ant Colony"])

# ╔═╡ ad8048a4-ba01-4881-915c-f62fb317c5bc


# ╔═╡ 4237a23c-4e2d-47fc-9c4d-2b831d46e902
begin
	if vismethod == "Simulated Annealing"
	    sorted, bestcost = annealing(10000.0, visarray, "2rand", 0.999, 100000)
	elseif vismethod == "Genetic Algorithm"
	    sorted, bestcost = genetic_algorithm(visarray, 100, 2000, 0.9)
	else
	    sorted = ant_colony_sort(visarray, 30, 4, 0.01, 10, 50)
	    bestcost = cost(sorted)
	end
	
	plot(sorted, title="Kolejność liczb w tablicy", seriestype=:bar)
end

# ╔═╡ 87997c1c-3a92-4771-9c89-0234c930e3e8
begin
	function plot_inversions(array)
	    n = length(array)
	    inversions = [(i, j) for i in 1:n-1 for j in i+1:n if array[i] > array[j]]
	    scatter(1:n, array, title="Inversions = $(length(inversions))", label="Values", legend=false)
	    for (i, j) in inversions
	        plot!([i, j], [array[i], array[j]], lc=:red, lw=0.5, label=false)
	    end
	end
	
	plot_inversions(array)
end

# ╔═╡ 1a4d193f-7655-42c0-accd-6525e6b6ad28
begin

	Random.seed!(123)

	ns = [5, 10, 20, 50]
	results = DataFrame(n=Int[], method=String[], time_ns=Float64[])

	for n in ns
		arr = shuffle(1:n)

		t1 = @belapsed annealing(10000.0, $arr, "2rand", 0.999, 100000)
		push!(results, (n, "Simulated Annealing", t1))

		t2 = @belapsed genetic_algorithm($arr, 100, 2000, 0.9)
		push!(results, (n, "Genetic Algorithm", t2))

		t3 = @belapsed sort(arr)
		push!(results, (n, "Sorting", t3))
...
manifest_format = "2.0"
project_hash = "26e385204e07f82f322cd64f49f32287d559f1af"
